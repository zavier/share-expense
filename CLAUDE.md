...
This is an expense sharing application (记账分摊软件) built with Java and Spring Boot, using the COLA (Clean Object-Oriented and Layered Architecture) framework. It provides functionality for recording expenses among friends, calculating settlement amounts, and sharing costs.
...
### REST API Design
- Base URL: `http://localhost:8081/expense`
...
- Login Endpoint: `/expense/user/login`
